...
RUN apt -y update && apt -y upgrade && apt -y install curl lsof procps findutils ripgrep wget build-essential cmake rustup tini git sudo jq sox python3 python-is-python3 python3-yaml libssl-dev pkg-config tmux
